...
class IndStatusCurvedNavigationBar extends StatefulWidget {
  @override
  _IndStatusCurvedNavigationBarState createState() => _IndStatusCurvedNavigationBarState();
}

class _IndStatusCurvedNavigationBarState extends State<IndStatusCurvedNavigationBar> {
  int _currentIndex=1;
  List _pages = [
