...
class IndMyProfileCurvedNavigationBar extends StatefulWidget {
  @override
  _IndMyProfileCurvedNavigationBarState createState() => _IndMyProfileCurvedNavigationBarState();
}

class _IndMyProfileCurvedNavigationBarState extends State<IndMyProfileCurvedNavigationBar> {
  int _currentIndex=3;
  List _pages = [
