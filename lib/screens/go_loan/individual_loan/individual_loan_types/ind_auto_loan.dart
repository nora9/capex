...
class IndAutoLoan extends StatefulWidget {
  @override
  _IndAutoLoanState createState() => _IndAutoLoanState();
}

class _IndAutoLoanState extends State<IndAutoLoan> {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Auto Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Brand*' , [
                'Alfa Romeo', 'Aston Martin' , 'AUdi' , 'Baic' , 'Bajaj' , 'Bnelli' , 'Bently']),
              SizedBox(height: 15,),
              _buildDropdownButtonFormField('Car Model*' , [
                '?', '?' , '?' , '?' , '?' , '?' , '?']),
              SizedBox(height: 15,),
              _buildDropdownButtonFormField('Auto Loan Distributor*' , [
                '?', '?' , '?' , '?' , '?' , '?']),
              SizedBox(height: 15,),
              _buildDropdownButtonFormField('Insurance Company*' , [
                'Misr Insurance', 'Alico' , 'GIG' , 'Allianz' , 'Royal and Sun' , 'AXA']),
              SizedBox(height: 20,),
