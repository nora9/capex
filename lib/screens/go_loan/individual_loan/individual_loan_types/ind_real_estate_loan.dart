...
class IndRealEstateLoan extends StatefulWidget {
  @override
  _IndRealEstateLoanState createState() => _IndRealEstateLoanState();
}

class _IndRealEstateLoanState extends State<IndRealEstateLoan> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              Text('Type Of Loan*' , style: TextStyle(color: Color(0xff3d5a96), fontSize: 16),),
              _buildTextFormField('Real Estate Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Type Of Mortgage*' , ['Apartment', 'Twin House' , 'Villa' , 'Town House']),
              SizedBox(height: 15,),
              Text('Project Name*' , style: TextStyle(color: Color(0xff3d5a96), fontSize: 16),),
              _buildTextFormField('' , TextInputType.name , false),
              SizedBox(height: 10,),
              Text('Developer Name*' , style: TextStyle(color: Color(0xff3d5a96), fontSize: 16),),
              _buildTextFormField('' , TextInputType.name , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Mortgage Loan Program*' , ['A', 'B' , 'C' , 'D' , 'E' , 'F' , 'G' , 'H' , 'I' , 'J']),
              SizedBox(height: 20,),
