...
class IndHouseholdLoan extends StatefulWidget {
  @override
  _IndHouseholdLoanState createState() => _IndHouseholdLoanState();
}

class _IndHouseholdLoanState extends State<IndHouseholdLoan> {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Household Appliance Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
