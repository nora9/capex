...
class IndPersonalLoan extends StatefulWidget {
  @override
  _IndPersonalLoanState createState() => _IndPersonalLoanState();
}

class _IndPersonalLoanState extends State<IndPersonalLoan> {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Personal Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Personal Loan Program*' , ['A', 'B' , 'C' , 'D' , 'E' , 'F' , 'G' , 'H' , 'I' , 'J']),
              SizedBox(height: 20,),
