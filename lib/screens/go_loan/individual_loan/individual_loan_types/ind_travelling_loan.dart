...
class IndTravellingLoan extends StatefulWidget {
  @override
  _IndTravellingLoanState createState() => _IndTravellingLoanState();
}

class _IndTravellingLoanState extends State<IndTravellingLoan> {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Travel Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Type Of Travel*' , ['?', '?' , '?' , '?']),
              SizedBox(height: 20,),
