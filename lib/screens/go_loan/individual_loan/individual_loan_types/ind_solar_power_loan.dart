...
class IndSolarPowerLoan extends StatefulWidget {
  @override
  _IndSolarPowerLoanState createState() => _IndSolarPowerLoanState();
}

class _IndSolarPowerLoanState extends State<IndSolarPowerLoan> {
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Solar Power Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              Text('Service Provider*' , style: TextStyle(color: Color(0xff3d5a96), fontSize: 16),),
              _buildTextFormField('' , TextInputType.name , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Solar Power Loan Program*' , ['A', 'B' , 'C' , 'D' , 'E' , 'F' , 'G' , 'H' , 'I' , 'J']),
              SizedBox(height: 20,),
