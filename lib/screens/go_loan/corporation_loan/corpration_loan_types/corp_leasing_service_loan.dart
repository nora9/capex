...
class CorpLeasingServiceLoan extends StatefulWidget {
  @override
  _CorpLeasingServiceLoanState createState() => _CorpLeasingServiceLoanState();
}

class _CorpLeasingServiceLoanState extends State<CorpLeasingServiceLoan> {
  final _formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('CorpLeasingServiceLoan'),
        leading: IconButton(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Leasing Service Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Leasing Service Loan Program*' , [
                'Direct Lease ????', 'Sales & Lease Back ????']),
              SizedBox(height: 20,),
