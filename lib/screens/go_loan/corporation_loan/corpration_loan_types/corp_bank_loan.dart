...
class CorpBankLoan extends StatefulWidget {
  @override
  _CorpBankLoanState createState() => _CorpBankLoanState();
}

class _CorpBankLoanState extends State<CorpBankLoan> {
  final _formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('CorpBankLoan'),
        leading: IconButton(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Bank Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Bank Loan Service Program*' , ['Short ??????', 'Medium ?????']),
              SizedBox(height: 15,),
              _buildDropdownButtonFormField('Above 1 Year*' , ['?', '?']),
              SizedBox(height: 15,),
              _buildDropdownButtonFormField('Less than 1 Year*' , ['?', '?']),
              SizedBox(height: 20,),
