...
class CorpMortgageServiceLoan extends StatefulWidget {
  @override
  _CorpMortgageServiceLoanState createState() => _CorpMortgageServiceLoanState();
}

class _CorpMortgageServiceLoanState extends State<CorpMortgageServiceLoan> {
  final _formKey = GlobalKey<FormState>();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('CorpMortgageServiceLoan'),
        leading: IconButton(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Mortgage Service Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Mortgage Service Loan*' , [
                'Discounted Checks', 'Discounted Checks Portfolio' , 'Project Encoding']),
              SizedBox(height: 20,),
