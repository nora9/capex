...
class CorpFactoringServiceLoan extends StatefulWidget {
  @override
  _CorpFactoringServiceLoanState createState() => _CorpFactoringServiceLoanState();
}

class _CorpFactoringServiceLoanState extends State<CorpFactoringServiceLoan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('CorpFactoringServiceLoan'),
        leading: IconButton(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildTextFormField('Factoring Service Loan' , TextInputType.name , true),
              SizedBox(height: 10,),
              ...
              _buildTextFormField('' , TextInputType.number , false),
              SizedBox(height: 10,),
              _buildDropdownButtonFormField('Factoring Service Loan Program*' , [
                'Time Loan Tradable Documents Whether Clients of Suppliers',
                'Time Loan against Checks' ,
                'Time Loan against Trade Bills' ,
                'Time Loan against Receivables' ,
                'Time Loan against Payables' ,
                'Time Loan against Invoices' ,
                'Time Loan against Export Letter of Credit']),
              SizedBox(height: 20,),
