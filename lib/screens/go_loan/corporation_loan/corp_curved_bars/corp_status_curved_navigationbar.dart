...
class CorpStatusCurvedNavigationBar extends StatefulWidget {
  @override
  _CorpStatusCurvedNavigationBarState createState() => _CorpStatusCurvedNavigationBarState();
}

class _CorpStatusCurvedNavigationBarState extends State<CorpStatusCurvedNavigationBar> {
  int _currentIndex=1;
  List _pages = [
