...
class CorpNewLoanCurvedNavigationBar extends StatefulWidget {
  @override
  _CorpNewLoanCurvedNavigationBarState createState() => _CorpNewLoanCurvedNavigationBarState();
}

class _CorpNewLoanCurvedNavigationBarState extends State<CorpNewLoanCurvedNavigationBar> {
  int _currentIndex=0;
  List _pages = [
