...
class CorpMyProfileCurvedNavigationBar extends StatefulWidget {
  @override
  _CorpMyProfileCurvedNavigationBarState createState() => _CorpMyProfileCurvedNavigationBarState();
}

class _CorpMyProfileCurvedNavigationBarState extends State<CorpMyProfileCurvedNavigationBar> {
  int _currentIndex=3;
  List _pages = [
